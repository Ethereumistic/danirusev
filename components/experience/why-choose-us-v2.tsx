...
const FEATURES: FeatureBlock[] = [
    {
        ...
        titleAccent: "За Занос",
        description: "Специално подготвени BMW-та с над 400 к.с., заварени диференциали и състезателни окачвания. Всеки детайл е настроен за перфектния дрифт — от хидроспирачката до ъгъла на волана.",
        stats: [
    ...
    },
    {
        ...
        description: "Обезопасено трасе без препятствия, каски и колани с 4-точково закрепване, винаги с инструктор до теб. Карай до лимита си знаейки, че всичко е под контрол.",
        stats: [
    ...
    },
    {
        ...
        title: "Незабравими",
        titleAccent: "Спомени",
        description: "Всяка сесия се заснема с GoPro камери от множество ъгли. Получаваш професионално монтирано видео — перфектно за социалните мрежи или просто за да го гледаш отново и отново.",
        stats: [
                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <Button
                            variant="outline"
                            size="lg"
                            className="border-main/50 text-main hover:bg-main hover:text-black font-bold uppercase tracking-wide group"
                            onClick={() => {
                                document
