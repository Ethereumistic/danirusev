...
export function ExperienceCard({
    ...
    return (
        <div
            onClick={handleClick}
            className={`group relative w-full max-w-[450px] mx-auto h-[550px] rounded-2xl overflow-hidden border hover:border-3 bg-slate-900 transition-all duration-300 hover:scale-[1.01] hover:z-50 transform-gpu cursor-pointer ${borderStyleClass} ${theme.border} ${isPending ? 'opacity-70 cursor-wait' : ''}`}
            >
                {/* Price Badge */}
                ...
                <div className="absolute inset-0 z-20 flex flex-col justify-end p-6">
                    ...
                    <div className="flex items-center gap-4 mb-6 text-slate-300 text-sm transform transition-transform duration-500 group-hover:-translate-y-2">
                        <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-nowrap">{experience.duration || '60 мин'}</span>
                        </div>
                        ...
                        <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-nowrap">{experience.techSpecs?.horsePower || 400} HP</span>
                        </div>
                    </div>
