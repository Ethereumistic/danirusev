...
export default function ResetPasswordPageClient({ children }: { children: React.ReactNode }) {
    return (
            ...
            >
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-4xl md:text-5xl font-black text-white uppercase tracking-tighter italic leading-none mb-4">
                        Нова <span className="text-main">Парола</span>
                    </h1>
                    <p className="text-slate-500 font-bold uppercase text-[10px] tracking-[0.2em] max-w-[280px] mx-auto leading-relaxed">
                        Въведете вашата нова парола, за да възстановите достъпа до акаунта си
                    </p>
                </div>
                ...
                >
                    Имате проблем с нулирането? <span className="text-slate-400">ruseffracing@gmail.com</span>
                </motion.p>
            </motion.div>
        </div>
    );
