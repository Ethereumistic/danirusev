-- ============================================
-- SUPABASE MIGRATION: Public wrapper functions for ecommerce
-- The functions live in public schema but access ecommerce tables
-- Run this in Supabase SQL Editor
-- ============================================

-- 1. Drop and recreate get_all_orders_with_details in public schema
...
-- 2. Drop and recreate create_order_from_webhook in public schema
...
BEGIN
    ...
    LOOP
        INSERT INTO ecommerce.order_items (
            ...
            variant, sku, item_type, location, addons,
