...
export function CheckoutForm({ profile }: CheckoutFormProps) {
  ...
  if (items.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center pt-4 px-8 space-y-8 text-center">
        ...
        <Button
          ...
          onClick={() => router.push('/#drift-experiences')}
        >
                ...
                {items.map(item => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Experience: Consolidated display of options and addons */}
                            ...
                            <div className="flex flex-wrap gap-2">
                              {item.storedLocationName && (
                                <div className="flex items-center gap-2 px-3 py-1.5 rounded-md bg-black/40 border border-white/10 backdrop-blur-md">
                                  <MapPin className={`h-3.5 w-3.5 ${getTextColor(item.themeColor)}`} />
                              ...
                              {item.storedSelectedDate && (
                                <div className="flex items-center gap-2 px-3 py-1.5 rounded-md bg-black/40 border border-white/10 backdrop-blur-md">
                                  <CalendarDays className={`h-3.5 w-3.5 ${getTextColor(item.themeColor)}`} />
                                  <span className="text-sm font-black uppercase text-white leading-none">
                                    {item.storedSelectedDate}
                                  </span>
                                </div>
                              ...
                              <div className="space-y-2">
                                ...
                                <div className="flex flex-col gap-2">
                                  {displayAddons.map((addon) => (
                                    <div
                                      key={addon.id}
                                      className={`flex items-center gap-3 p-3 rounded-xl ${theme.bgFaded} border-2 ${theme.borderFaded} transition-all`}
                                    >
                                      {(() => {
                                        ...
                                        if (IconComponent) {
                                          return (
                                            <div className={`p-1.5 rounded-lg bg-black/40 border ${theme.borderFaded}`}>
                                        ...
                                        return (
                                          <div className={`p-1.5 rounded-lg bg-black/40 border ${theme.borderFaded}`}>
                                            <div className={`w-2 h-2 rounded-full ${theme.bg} shadow-sm shadow-black shrink-0`} />
                                          </div>
                                        );
                                      })()}
                                      ...
                                      {addon.price > 0 ? (
                                        ...
                                        <span className="text-slate-500 text-[10px] font-black uppercase">Вкл.</span>
                                      )}
                                    </div>
                                  ))}
                                </div>
