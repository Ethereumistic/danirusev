  ...
  return (
    <div className="min-h-[90vh] flex flex-col items-center justify-center py-12 px-4 relative overflow-hidden">
      ...
      >
        ...
        >
          Имате проблем с входа? <span className="text-slate-400">ruseffracing@gmail.com</span>
        </motion.p>
      </motion.div>
    </div>
  );
